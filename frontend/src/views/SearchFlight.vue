      ...
      <v-expansion-panel-content>
        ...
        <v-card class="card">
          <v-form
            ...
            >
            <v-card-text>
              <v-btn @click="oneWayBtnClicked" :color="oneWayBtnColor">One-Way</v-btn>
              ...
              <v-container fluid>
                <v-layout row wrap>
                  ...
                  >
                    ...
                    <v-date-picker v-model="search.departureDate" no-title scrollable>
                      <v-spacer></v-spacer>
                      <v-btn flat color="primary" @click="menuDepartureDate = false">Cancel</v-btn>
                      <v-btn flat color="primary" @click="$refs.menuDepartureDate.save(search.departureDate)">OK</v-btn>
                    </v-date-picker>
                  </v-menu>
                  </v-flex>
                  ...
                  >
                    ...
                    <v-date-picker v-model="search.returnDate" no-title scrollable>
                      <v-spacer></v-spacer>
                      <v-btn flat color="primary" @click="menuReturnDate = false">Cancel</v-btn>
                      <v-btn flat color="primary" @click="$refs.menuReturnDate.save(search.returnDate)">OK</v-btn>
                    </v-date-picker>
                  </v-menu>
                  </v-flex>
                  <v-flex lg2>
...
export default {
  ...
  data:() => ({
    ...
    seatClasses: ['First', 'Buissness', 'Economy'],
