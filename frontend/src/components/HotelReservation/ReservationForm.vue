 ...
 <div>
    ...
    <v-card>
          ...
          <v-stepper v-model="step" vertical>
            <v-stepper-header>
              <v-stepper-step step="1" :complete="step > 1">Booking time</v-stepper-step>
              <v-divider></v-divider>
              <v-stepper-step step="2" :complete="step > 2">Select rooms</v-stepper-step>
              <v-divider></v-divider>
              <v-stepper-step step="3" :complete="step > 3">Additional service</v-stepper-step>
              <v-divider></v-divider>
              <v-stepper-step step="4" :complete="step > 4">Overview</v-stepper-step>
              <v-divider></v-divider>
            </v-stepper-header>
            <v-stepper-items>
              <v-stepper-content step="1">
                ...
                <v-layout>
                  <v-flex>
                    ...
                    <number-input v-model="numOfPeople" :min="0" :max="6" inline center controls  :rules="[v => !!v || 'Num of people is required']"></number-input>
                  </v-flex>
                </v-layout>
              ...
              <v-stepper-content step="2">
                ...
                <v-layout row wrap v-if=" myHotel != null">
                    ...
                    <v-btn small :disabled="checkDisabled(room)"
                      ...
                      <v-container fluid grid-list-md v-if="pickedRooms.length !== 0">
                          ...
                          <template v-slot:item="props">
                            <v-flex xs12 sm6 md4 lg3>
                              ...
                              <v-card>
                                <v-card-title><h4>{{ props.item.numberOfBeds }}</h4>
                                              <v-icon large> airline_seat_individual_suite</v-icon></v-card-title>
                                <v-divider></v-divider>
                                <v-list dense>
                                  <v-list-tile>
                                  ...
                                  <v-list-tile>
                                    ...
                                    <v-list-tile-content class="align-end">Price</v-list-tile-content>
                                  </v-list-tile>
                                </v-list>
                                <v-card-actions>
                                  <v-spacer></v-spacer>
                                  <v-btn color="error" @click="removeRoom('', props.item)">REMOVE
                          ...
                          <template v-slot:footer>
                              <v-toolbar
                                ...
                                flat
                              >
                              <v-toolbar-title class="subheading"><h1>Total price {{totalPrice}} EUR for night</h1></v-toolbar-title>
                            </v-toolbar>
                          </template>
                        </v-data-iterator>
                      </v-container>
                ...
                <v-btn color="primary" @click.native="continueTo(3)">Continue</v-btn>
              ...
              <v-stepper-content step="3">
                <v-subheader><h3>Choose additional service that you want to use.(None, one or more)</h3></v-subheader>
                ...
                <v-btn color="primary" @click.native="continueTo(4)">Continue</v-btn>
              </v-stepper-content>  
                ...
                <!-- <img src="@/assets/moskva.jpg"> -->
                      <h3 class="headline mb-0">Confirm reservation</h3>
                        ...
                        <v-layout row wrap align-center>
                          <v-flex xs6>
                            <v-subheader><span><h3>Check in date: </h3></span></v-subheader>
                          </v-flex>
                          <v-flex xs6>
                            <v-subheader><span><h3>{{checkInDate}}</h3></span></v-subheader>
                          </v-flex>
                        </v-layout>

                        <v-layout row wrap align-center>
                          <v-flex xs6>
                            <v-subheader><span><h3>Check out date: </h3></span></v-subheader>
                          </v-flex>
                          <v-flex xs6>
                            <v-subheader><span><h3>{{checkOutDate}}</h3></span></v-subheader>
                          </v-flex>
                        </v-layout>

                        <v-layout row wrap align-center>
                          <v-flex xs6>
                            <v-subheader><span><h3>Number of people: </h3></span></v-subheader>
                          </v-flex>
                          <v-flex xs6>
                            <v-subheader><span><h3>{{numOfPeople}}</h3></span></v-subheader>
                          </v-flex>
                        </v-layout>
                            <v-data-table
                              :items="selected"
                            ...
                            <template v-slot:header>
                              <v-toolbar class="mb-2" color="indigo darken-5" dark flat
                              >
                                <v-toolbar-title><h1>Additional services</h1></v-toolbar-title>
                              </v-toolbar>
                            </template>
                            <template v-slot:items="props">
                              <td class="text-xs-center">{{ props.item.description }}</td>
                              ...
                              <template v-slot:item="props">
                                ...
                                <template v-slot:footer>
                                  <v-toolbar
                                    ...
                                    flat
                                  >
                                  <v-toolbar-title class="subheading"><h1>Total price {{totalWithAdditional}} EUR for night</h1></v-toolbar-title>
                                  </v-toolbar>
                                </template>
        ...
        if(number == 2){
          ...
          // }
            ...
            if(this.enough){
              ...
              this.showSnackbar({msg: "You dont have enough beds.", color: "error"});
            }
        }else if(number == 4){
          this.step = 4;
        }
