    ...
    <v-card max-width="auto">
      <v-form ref="form" v-model="form" lazy-validation>
         ...
         <v-card-text>
            ...
            <v-flex xs6>
               <v-subheader><span><h3>Room image: </h3></span></v-subheader>
            </v-flex>
            <v-flex xs6>
              <img id="pic" src="@/assets/oneBed.jpg" v-if="room.numberOfBeds == 1">
              <img id="pic" src="@/assets/twoBeds.jpg" v-if="room.numberOfBeds == 2">
              <img id="pic" src="@/assets/threeBeds.jpg" v-if="room.numberOfBeds == 3">
              <img id="pic" src="@/assets/fourBeds.jpg" v-if="room.numberOfBeds == 4">
              <img id="pic" src="@/assets/fiveBeds.jpg" v-if="room.numberOfBeds == 5">
            </v-flex>
            <v-flex xs6>
                <v-subheader><span v-if="room.roomTaken.length>0"><h3>Dates when room is reserved: </h3></span></v-subheader>
            </v-flex>
            <v-flex xs6>
                <v-list>
                <v-list-tile
            ...
            <v-flex xs6>
              <v-subheader><span v-if="room.specialPrices.length>0"><h3>Dates when room has special prices: </h3></span></v-subheader>
            </v-flex>
            <v-flex xs6>
                <v-list>
