          ...
          <v-layout row wrap align-center>
            ...
            <v-flex lg3 md4 sm4 xs12>
              <v-container class="container-flight-info">
                ...
                <v-flex lg12 md12 sm12 xs12>
                  <label class="city">{{data.startDestination.zip}} [{{data.startDestination.name}}]</label>
                </v-flex>
              </v-layout>
              </v-container>
            </v-flex> 
            <v-flex lg3 md4 sm4 xs12>
              <v-container class="container-flight-info">
                <v-layout row wrap>
                <v-flex lg12 md12 sm12 xs12>
                  <label>Flight duration: {{data.flightTimeHours}}h {{data.flightTimeMinutes}}m</label>
                </v-flex>
                ...
                <v-flex lg12 md12 sm12 xs12>
                  <label>Stops: </label>
                  <label v-if="data.transferDestinations.length == 0">0</label>
                  <label v-for="(item,index) in data.transferDestinations" :key="index">{{item}}</label>
                </v-flex>
              </v-layout>
              </v-container>
            </v-flex>
            <v-flex lg3 md4 sm4 xs12>
              <v-container class="container-flight-info">
                <v-layout row wrap>
                  ...
                  <v-flex lg12 md12 sm12 xs12>
                    <label class="city">{{data.finalDestination.zip}}[{{data.finalDestination.name}}]</label>
                  </v-flex>
                </v-layout>
              </v-container>
            </v-flex>
