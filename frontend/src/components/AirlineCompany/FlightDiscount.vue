  ...
  <div>
    <v-dialog v-model="dialog" persistent>
      ...
      <v-card>
        ...
        <v-card-text>
          <div>Select class, then choose a seat and enter a discount</div>
          <br />
          <v-expansion-panel>
            <v-expansion-panel-content>
              ...
              <seats
                v-bind:seatsDeparture="flight.seatsFirst"
                v-bind:seatsReturn="null"
                v-bind:passengers="100"
                v-bind:discount="true"
              ></seats>
              <v-text-field
                box
                type="number"
                label="Enter discount for first class in percent"
                v-model="discountFirst"
              ></v-text-field>
            </v-expansion-panel-content>
            <v-expansion-panel-content>
              <template v-slot:header>
              ...
              <seats
                v-bind:seatsDeparture="flight.seatsBusiness"
                v-bind:seatsReturn="null"
                v-bind:passengers="100"
                v-bind:discount="true"
              ></seats>
              <v-text-field
                box
                type="number"
                label="Enter discount for business class in percent"
                v-model="discountBusiness"
              ></v-text-field>
            </v-expansion-panel-content>
            <v-expansion-panel-content>
              <template v-slot:header>
              ...
              <seats
                v-bind:seatsDeparture="flight.seatsEconomy"
                v-bind:seatsReturn="null"
                v-bind:passengers="100"
                v-bind:discount="true"
              ></seats>
              <v-text-field
                box
                type="number"
                label="Enter discount for economy class in percent"
                v-model="discountEconomy"
              ></v-text-field>
            </v-expansion-panel-content>
          </v-expansion-panel>
        </v-card-text>
