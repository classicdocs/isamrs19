              ...
              <v-flex lg2>
                ...
                >
                  ...
                  <v-date-picker
                    ...
                    scrollable
                  >
                    <v-btn flat color="primary" @click="menuCheckInDate = false"
                      >Cancel</v-btn
                    >
                    <v-spacer></v-spacer>
                    <v-btn
                      flat
                      color="primary"
                      @click="$refs.menuCheckInDate.save(search.checkInDate)"
                      >OK</v-btn
                    >
                  </v-date-picker>
                </v-menu>
                ...
                >
                  ...
                  >
                    ...
                    <v-btn
                      flat
                      color="primary"
                      @click="$refs.menuCheckOutDate.save(search.checkOutDate)"
                      >OK</v-btn
                    >
                  </v-date-picker>
                </v-menu>
