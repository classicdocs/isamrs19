<template>
  <div>
    <v-dialog v-model="addFormDialog" max-width="auto" persistent>
            ...
            <v-layout row wrap>
              <v-flex lg10 md10 sm12 xs12 v-if="hfp.floors != null">
                <v-layout row wrap>
                  ...
                  <v-flex
                    ...
                    sm12
                    xs12
                    v-for="floor in hotel.numOfFloors"
                    :key="floor"
                  >
                    ...
                    <v-btn
                      small
                      v-for="(roomPosition, index) in hfp.floors[floor - 1]
                        .positions"
                      :key="index"
              ...
              <v-layout row wrap>
                <v-flex row wrap>
                  ...
                  <h3>
                    Floor: {{ pickedPosition.level }}, Room number:
    ...
    setPositions() {
      ...
      this.hotel.floors.forEach(f => {
        ...
        for (var roomNUM = 1; roomNUM <= this.hotel.roomsByFloor; roomNUM++) {
          ...
          position.level = floorNUM;
          position.exists = false;
          position.number = roomNUM;
