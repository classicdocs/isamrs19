        ...
        >
          <template v-slot:items="props">
            <tr @click="props.expanded = !props.expanded">
              ...
              <td class="text-xs-center" v-if="props.item.numberOfBeds == 1">
                1 - ONE
              </td>
              <td class="text-xs-center" v-if="props.item.numberOfBeds == 2">
                2 - TWO
              </td>
              <td class="text-xs-center" v-if="props.item.numberOfBeds == 3">
                3 - THREE
              </td>
              <td class="text-xs-center" v-if="props.item.numberOfBeds == 4">
                4 - FOUR
              </td>
              <td class="text-xs-center" v-if="props.item.numberOfBeds == 5">
                5 - FIVE
              </td>

              <td
                class="text-xs-center"
                v-if="props.item.roomTaken.length == 0"
              >
                FREE
              </td>
              <td
