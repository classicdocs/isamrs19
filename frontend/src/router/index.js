...
router.beforeEach((to, from, next) => {
  ...
  if (
    store.getters.isAirlineAdmin &&
    !to.meta.airlineAdmin &&
    !to.meta.admin &&
    !to.meta.logged
  ) {
    return next({
      name: "airline-company",
      params: { id: store.getters.activeUser.idAdminOf }
    });
  }
  ...
  if (
    store.getters.isAirlineAdmin &&
    to.meta.airlineAdmin &&
    to.params.id !== store.getters.activeUser.idAdminOf
  ) {
    return next({
      name: "airline-company",
      params: { id: store.getters.activeUser.idAdminOf }
  ...
  if (
    store.getters.isRentacarAdmin &&
    !to.meta.rentacarAdmin &&
    !to.meta.admin &&
    !to.meta.logged
  ) {
    return next({
