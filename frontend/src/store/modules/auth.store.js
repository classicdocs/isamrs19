...
const getters = {
  ...
  isAdmin: (state, getters) =>
    (getters.isLogged && getters.isAirlineAdmin) ||
    getters.isHotelAdmin ||
    getters.isRentacarAdmin,
  isSysAdmin: (state, getters) =>
    getters.isLogged && state.activeUser.isSysAdmin(),
  isAirlineAdmin: (state, getters) =>
    getters.isLogged && state.activeUser.isAirlineAdmin(),
  isHotelAdmin: (state, getters) =>
    getters.isLogged && state.activeUser.isHotelAdmin(),
  isRentacarAdmin: (state, getters) =>
    getters.isLogged && state.activeUser.isRentacarAdmin(),
