...
insert into airline_company_destinations(airline_company_id, destinations ) values (1, 1);
insert into airline_company_destinations(airline_company_id, destinations ) values (1, 2);
insert into airline_company_destinations(airline_company_id, destinations ) values (1, 3);
